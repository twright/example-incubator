...
from software.src.shared.protocol import decode_json, encode_json
...
class RPCServer:
    ...
    This communication can be scaled horizontally, so beware of keeping state in python objects.
